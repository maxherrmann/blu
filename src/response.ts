...
export default class BluResponse {
	 ...
	 *  given request. Meant to be overridden by class extensions. If it returns
	 *  `true` the response is considered a matching response for the given
	 *  request. If it returns false the response is considered to not be a
	 *  match and is ignored. Returns `true` by default.
